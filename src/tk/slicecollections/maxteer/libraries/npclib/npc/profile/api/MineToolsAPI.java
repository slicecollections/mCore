...
public class MineToolsAPI extends Mojang {
  ...
  public String fetchSkinProperty(String id) {
    ...
    try {
      ...
      JsonObject properties = new JsonParser().parse(builder.toString()).getAsJsonObject()
          .get("raw").getAsJsonObject().get("properties").getAsJsonArray().get(0).getAsJsonObject();

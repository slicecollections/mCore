...
public class Accessors {
  ...
  /**
   * Um encurtador sem tipo para {@link Accessors#getField(Class, fieldName, Class)}
   */
   ...
   * @param index O índice para pegar o Método, caso chegue em 0 retorna o Metodo.
  ...
  public static MethodAccessor getMethod(Class clazz, int index, Class returnType, String methodName, Class... parameters) {
    ...
    for (final Method method : clazz.getDeclaredMethods()) {
      if ((methodName == null || method.getName().equals(methodName)) && (returnType == null || method.getReturnType().equals(returnType))
          && (parameters == null || Arrays.equals(method.getParameterTypes(), parameters)) && index-- == 0) {

...
import static tk.slicecollections.maxteer.servers.ServerItem.CONFIG;
import static tk.slicecollections.maxteer.servers.ServerItem.DISABLED_SLOTS;
import static tk.slicecollections.maxteer.servers.ServerItem.listServers;
      ...
      if (evt.getWhoClicked().equals(this.player)) {
        ...
        if (evt.getClickedInventory() != null && evt.getClickedInventory().equals(this.getInventory())) {
          ...
          if (item != null && item.getType() != Material.AIR) {
            ...
            ServerItem serverItem = listServers().stream().filter(s -> s.getSlot() == evt.getSlot()).findFirst().orElse(null);
            if (serverItem != null) {

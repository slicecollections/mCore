...
public class AbstractNPC implements NPC {
  ...
  public boolean spawn(Location location) {
    ...
    boolean couldSpawn = !Utils.isLoaded(location) ? false
        : NMS.addToWorld(location.getWorld(), controller.getBukkitEntity(), SpawnReason.CUSTOM);
    if (couldSpawn) {
  ...
  public boolean isSpawned() {
    return controller != null && controller.getBukkitEntity() != null
        && controller.getBukkitEntity().isValid();
  }
  ...
  public Location getCurrentLocation() {
    return getTrait(CurrentLocation.class).getLocation().getWorld() != null
        ? getTrait(CurrentLocation.class).getLocation()
        : isSpawned() ? getEntity().getLocation() : null;
  }

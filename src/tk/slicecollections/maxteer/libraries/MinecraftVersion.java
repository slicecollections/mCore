...
public class MinecraftVersion {
  ...
  /**
   * Verifique se essa versão é menos recente do que a requisitada.
   * 
   * @param version A versão para comparar.
   * @return TRUE se for menos recente, FALSE se for mais recente ou igual.
   */
  ...
  /**
   * Verifique se essa versão é mais recente do que a requisitada.
   * 
   * @param version A versão para comparar.
   * @return TRUE se for mais recente, FALSE se for menos recente ou igual.
   */
